...
public class PostService {
    ...
    private static final String POSTIMAGEPATH =  "D:\\HangHae99\\portfolio_SpringBootProject\\LookAtMyCatPlatform\\module_activityService\\images\\postImage\\";
    ...
    public void post(PostDTO postDTO, Long userKey) throws IOException {
        ...
        String userNick = userClient.getUserNickByUserKey(userKey);
